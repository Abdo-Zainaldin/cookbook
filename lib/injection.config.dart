...
import 'application/recipe_actor/recipe_actor_bloc.dart' as _i10;
import 'application/recipe_form/recipe_form_bloc.dart' as _i11;
import 'application/recipe_watcher/recipe_watcher_bloc.dart' as _i12;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i10.RecipeActorBloc>(
      () => _i10.RecipeActorBloc(get<_i8.IRecipeRepository>()));
  gh.factory<_i11.RecipeFormBloc>(
      () => _i11.RecipeFormBloc(get<_i8.IRecipeRepository>()));
  gh.factory<_i12.RecipeWatcherBloc>(
      () => _i12.RecipeWatcherBloc(get<_i8.IRecipeRepository>()));
